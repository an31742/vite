...
<template>
  <div class="home-page" style="padding: 40px;">
    ...
    <div class="btn-group" style="margin: 20px 0;">
      <el-button type="primary" @click="openUserForm">1. 打开用户表单弹窗</el-button>
      <el-button type="primary" @click="openEditUserForm">2. 打开编辑用户弹窗</el-button>
      <el-button type="warning" @click="openDeleteConfirm">3. 打开删除确认弹窗（叠加）</el-button>
      <el-button type="info" @click="openOrderDetail">4. 打开订单详情弹窗（分块打包）</el-button>
    </div>
    <div class="btn-group" style="margin: 20px 0;">
    ...
    <div class="stack-info" style="margin-top: 20px; padding: 20px; border: 1px solid #e6e6e6; border-radius: 4px;">
      <h3>当前弹窗栈状态：</h3>
